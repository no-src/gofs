...
func TestIntegration_RemoteDisk(t *testing.T) {
	testCases := []struct {
		...
		{"gofs remote disk with insecure", "run-gofs-remote-disk-server-with-insecure.yaml", "run-gofs-remote-disk-client-with-insecure.yaml", "test-gofs-remote-disk.yaml"},
