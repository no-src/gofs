...
func TestIsEqual_ReturnError(t *testing.T) {
	testCases := []commandCase{
		...
		{"zero source file", isEqual{Source: "../version/commit", Dest: "./is_equal_test.go", Expect: true, MustNonEmpty: true}},
		{"zero dest file", isEqual{Source: "./is_equal_test.go", Dest: "../version/commit", Expect: true, MustNonEmpty: true}},
